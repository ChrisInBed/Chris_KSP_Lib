...
GLOBAL F9_ASCENT_PARAMS IS LEXICON(
    ...
    "mecoMass", 195 + payloadMass,  // When the mass is below MECO mass, trigger MECO, ton
    ...
    "pitchOmega", 0.35,  // Programmed turn pitching speed, deg/s
    "stageSeparationDelay", 1,  // Time between MECO and 1st Stage Separation, s
    "upperStageIgnitionDelay", 4  // Time between 1st Stage Separation and second stage ignition, s
).
