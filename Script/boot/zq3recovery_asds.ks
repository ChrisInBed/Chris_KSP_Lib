...
GLOBAL F9_PARAMS IS LEXICON(
    ...
    "landingSiteWaypoint", "ASDS-ZhuQue3-Cape",  // name of waypoint, use waypoint altitude as altitude
    ...
    "gfold_engineSwitchTime", 8,  // Seconds after powered guidance starts
    "gfold_pitRadius", 0,
    "gfold_wallBuffer", 0,
    "gfold_pitDepth", 0,
    ...
    "entryBurnAlt", 65000,  // Altitude to perform entry burn, m
    ...
    "landingBurnAltitude", 1600,  // Ignite decelerating engines (or landing fallback) below this, m
