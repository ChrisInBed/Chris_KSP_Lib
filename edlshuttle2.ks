...
declare global entry_bank_rate to 3.  // deg/s
declare global pitch_pid to pidLoop(0.1, 0.005, 0.01, -1, 1).
declare global bank_pid to pidLoop(0.1, 0.005, 0.01, -1, 1).
declare global yaw_pid to pidLoop(0.4, 0.005, 0.01, -1, 1).
...
function initialize_guidance {
    ...
    entry_set_profile(
        ...
        list(13, 25, 30, 35) // AOA profile in degrees
    ).
...
function entry_phase {
    ...
    activate_aero_control(_control["AOA"], _control["bank"]).
...
function activate_aero_control {
    ...
    declare global att_AOA to _AOA.
    declare global att_Bank to _Bank.
    declare global att_done to false.
    when (not att_done) then {
        set ship:control:pilotpitchtrim to pitch_pid:update(time:seconds, FAR:AOA - att_AOA).
        set ship:control:pilotrolltrim to bank_pid:update(time:seconds, get_bank() - att_Bank).
        set ship:control:pilotyawtrim to yaw_pid:update(time:seconds, FAR:AOS).
        return true.
    }.
    unlock steering.
}
...
function gui_make_entrylandgui {
    ...
    declare global gui_pitch_Kp_input to gui_pitch_box:addtextfield(pitch_pid:kp:tostring).
    set gui_pitch_Kp_input:onconfirm to {
        parameter newval.
        set pitch_pid:kp to newval:tonumber.
    }.
    declare global gui_pitch_Ki_label to gui_pitch_box:addlabel("Ki:").
    declare global gui_pitch_Ki_input to gui_pitch_box:addtextfield(pitch_pid:ki:tostring).
    set gui_pitch_Ki_input:onconfirm to {
        parameter newval.
        set pitch_pid:ki to newval:tonumber.
    }.
    declare global gui_pitch_Kd_label to gui_pitch_box:addlabel("Kd:").
    declare global gui_pitch_Kd_input to gui_pitch_box:addtextfield(pitch_pid:kd:tostring).
    set gui_pitch_Kd_input:onconfirm to {
        parameter newval.
        set pitch_pid:kd to newval:tonumber.
    }.
    declare global gui_pitch_Ep_label to gui_pitch_box:addlabel("Ep:").
    declare global gui_pitch_Ep_input to gui_pitch_box:addtextfield(pitch_pid:epsilon:tostring).
    set gui_pitch_Ep_input:onconfirm to {
        parameter newval.
        set pitch_pid:epsilon to newval:tonumber.
    }.

    // Bank control
    declare global gui_bank_label to gui_maingui:addlabel("Bank").
    declare global gui_bank_box to gui_maingui:addhbox().
    declare global gui_bank_Kp_label to gui_bank_box:addlabel("Kp:").
    declare global gui_bank_Kp_input to gui_bank_box:addtextfield(bank_pid:kp:tostring).
    set gui_bank_Kp_input:onconfirm to {
        parameter newval.
        set bank_pid:kp to newval:tonumber.
    }.
    declare global gui_bank_Ki_label to gui_bank_box:addlabel("Ki:").
    declare global gui_bank_Ki_input to gui_bank_box:addtextfield(bank_pid:ki:tostring).
    set gui_bank_Ki_input:onconfirm to {
        parameter newval.
        set bank_pid:ki to newval:tonumber.
    }.
    declare global gui_bank_Kd_label to gui_bank_box:addlabel("Kd:").
    declare global gui_bank_Kd_input to gui_bank_box:addtextfield(bank_pid:kd:tostring).
    set gui_bank_Kd_input:onconfirm to {
        parameter newval.
        set bank_pid:kd to newval:tonumber.
    }.
    declare global gui_bank_Ep_label to gui_bank_box:addlabel("Ep:").
    declare global gui_bank_Ep_input to gui_bank_box:addtextfield(bank_pid:epsilon:tostring).
    set gui_bank_Ep_input:onconfirm to {
        parameter newval.
        set bank_pid:epsilon to newval:tonumber.
    }.
    ...
    declare global gui_yaw_Kp_input to gui_yaw_box:addtextfield(yaw_pid:kp:tostring).
    set gui_yaw_Kp_input:onconfirm to {
        parameter newval.
        set yaw_pid:kp to newval:tonumber.
    }.
    declare global gui_yaw_Ki_label to gui_yaw_box:addlabel("Ki:").
    declare global gui_yaw_Ki_input to gui_yaw_box:addtextfield(yaw_pid:ki:tostring).
    set gui_yaw_Ki_input:onconfirm to {
        parameter newval.
        set yaw_pid:ki to newval:tonumber.
    }.
    declare global gui_yaw_Kd_label to gui_yaw_box:addlabel("Kd:").
    declare global gui_yaw_Kd_input to gui_yaw_box:addtextfield(yaw_pid:kd:tostring).
    set gui_yaw_Kd_input:onconfirm to {
        parameter newval.
        set yaw_pid:kd to newval:tonumber.
    }.
    declare global gui_yaw_Ep_label to gui_yaw_box:addlabel("Ep:").
    declare global gui_yaw_Ep_input to gui_yaw_box:addtextfield(yaw_pid:epsilon:tostring).
    set gui_yaw_Ep_input:onconfirm to {
        parameter newval.
        set yaw_pid:epsilon to newval:tonumber.
    }.
