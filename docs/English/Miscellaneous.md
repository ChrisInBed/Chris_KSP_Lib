...
> [!CAUTION]
> When you type `exe_pulse_node` into kOS terminal, Atmosphere Autopilot (AA) might be activated on its default keybinding `[P]`, causing flight control wobbling. You can press `[P]` another time to deactivate AA, or change keybindings.
