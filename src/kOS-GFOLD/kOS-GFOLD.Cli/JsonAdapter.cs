...
namespace KOSGFOLD.Cli
{
    internal static class JsonAdapter
    {
        ...
        internal static UpdateRequest ParseUpdate(Dictionary<string, object> d, PlannerResult previous) { return new UpdateRequest { Session = previous.Session, Previous = previous, StateTime = D(d, "stateTime"), Position = V(d, "position"), Velocity = V(d, "velocity"), Mass = D(d, "mass") }; }
